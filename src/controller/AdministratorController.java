...
/**
 * Controls the administrative operations and user interactions specific to administrators.
 * Manages staff, appointments, medication inventory, and system logs.
 * Provides methods to unlock user accounts and approve refill requests.
...
public class AdministratorController extends SessionController {
    ...
    public void sendMessage(RefillRequest r) {
        ...
        r.getRequestedAmount() + " successfully fulfilled!";
    ...
    /**
     * Adds a new staff member to the hospital staff.
     * Prompts the user to enter the role, ID, and name of the staff member.
     * Checks for duplicates and adds the staff member if they do not already exist.
     * Prints a confirmation message or an error message if the staff member already exists.
     */
    ...
    /**
     * Removes a staff member from the hospital staff.
     * Prompts the user to enter the role and ID of the staff member to be removed.
     * Removes the staff member if they exist and prints a confirmation message.
     * Prints an error message if the staff member does not exist.
     */
